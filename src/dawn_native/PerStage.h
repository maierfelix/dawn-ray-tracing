...
namespace dawn_native {
    ...
    static_assert(static_cast<uint32_t>(wgpu::ShaderStage::Compute) ==
                  ...
                  "");
    static_assert(static_cast<uint32_t>(wgpu::ShaderStage::RayGeneration) == (1 << static_cast<uint32_t>(SingleShaderStage::RayGeneration)), "");
    static_assert(static_cast<uint32_t>(wgpu::ShaderStage::RayAnyHit) ==
                      (1 << static_cast<uint32_t>(SingleShaderStage::RayAnyHit)),
                  "");
    static_assert(static_cast<uint32_t>(wgpu::ShaderStage::RayClosestHit) ==
                      (1 << static_cast<uint32_t>(SingleShaderStage::RayClosestHit)),
                  "");
